...
export default function ComponentesEstilizados() {
  // Primero definir la etiqueta de la libreria Styled Components
  ...
  // Funcionalidad para heredar los estilos previamente estilizados
  ...
  return (
    <>
      ...
      {/* ThemeProvider es un container de propiedades */}
